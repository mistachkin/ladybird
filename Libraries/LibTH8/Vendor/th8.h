 ...
 *
 * On Linux/glibc with -std=c99, POSIX and X/Open extensions
 * (O_CLOEXEC, pthread_getattr_np, realpath, dladdr, strdup,
 * etc.) are hidden unless feature test macros are defined.
 *
 *   _GNU_SOURCE              -- glibc superset (implies both
 *       _POSIX_C_SOURCE and _XOPEN_SOURCE).
 *   _POSIX_C_SOURCE 200809L  -- POSIX.1-2008 (for non-glibc
 *       systems like FreeBSD/OpenBSD).
 *
 * On macOS, the default headers expose everything; defining
 * _XOPEN_SOURCE or _POSIX_C_SOURCE actually RESTRICTS the
 * visible API.  So we only define these on Linux and generic
 * POSIX systems, not on Apple platforms.
 *
 * On musl libc, all feature test macros are ignored (the full
 * API is always visible).
 */

#if !defined(_WIN32) && !defined(WIN32) && !defined(__APPLE__)
#  ifndef _GNU_SOURCE
#    define _GNU_SOURCE          /* glibc: superset of all POSIX/X/Open. */
#  endif
#  ifndef _POSIX_C_SOURCE
#    define _POSIX_C_SOURCE 200809L  /* FreeBSD, OpenBSD, Solaris. */
#  endif
#endif
 ...
 *   <stddef.h>  -- size_t
 *   <stdarg.h>  -- va_list (for xVsnprintf platform callback)
 */
...
#define TH8_SIZECHECK(I,N) \
    if((N)>TH8_MX_STRLEN){th8OversizeString((I));}
...
struct Th8_Platform {
    ...
    /*
     * xDeleteInterp --
     *	Called by Th8_DeleteInterp just before the interpreter struct
     *	is freed.  The platform can use this to release per-interpreter
     *	resources (e.g., dlclose loaded libraries, free platform-specific
     *	state).  If NULL, no action is taken.
     */
     ...
     */
    void *(*xMemcpy)(Th8_Interp *interp, void *pCtx,
     ...
     */
    void *(*xMemmove)(Th8_Interp *interp, void *pCtx,
		      void *dst, const void *src, size_t n);
     ...
     */
    void *(*xMemset)(Th8_Interp *interp, void *pCtx,
		     void *dst, int c, size_t n);
     ...
     *	variable resolution.
     */
    int   (*xMemcmp)(Th8_Interp *interp, void *pCtx,
     ...
     */
    int    (*xStrcmp)(Th8_Interp *interp, void *pCtx,
     ...
     */
    char  *(*xStrchr)(Th8_Interp *interp, void *pCtx,
		      const char *s, int c);
     ...
     */
    void   (*xQsort)(Th8_Interp *interp, void *pCtx,
     ...
     */
    int    (*xVsnprintf)(Th8_Interp *interp, void *pCtx,
     ...
     */
    void (*xMutexInit)(Th8_Interp *interp, void *pCtx,
		       Th8_Mutex *pMutex);
    void (*xMutexFinal)(Th8_Interp *interp, void *pCtx,
			Th8_Mutex *pMutex);
    void (*xMutexEnter)(Th8_Interp *interp, void *pCtx,
			Th8_Mutex *pMutex);
    void (*xMutexLeave)(Th8_Interp *interp, void *pCtx,
			Th8_Mutex *pMutex);
     ...
     *	assumption).
     */
    int (*xIntCmpXchg)(Th8_Interp *interp, void *pCtx,
		       volatile int *pTarget, int iExchange,
                       int iComparand);
     ...
     *	are unavailable.
     */
    int   (*xInput)(Th8_Interp *interp, void *pCtx,
		     char **pzOut, size_t *pnOut, void *pChannel);
     ...
     */
    int   (*xOutput)(Th8_Interp *interp, void *pCtx,
		      const char *z, size_t n, void *pChannel);
     ...
     */
    int   (*xOutputError)(Th8_Interp *interp, void *pCtx,
		      const char *z, size_t n, void *pChannel);
     ...
     */
    int   (*xGetInput)(Th8_Interp *interp, void *pCtx,
		       void **pChannel);
    int   (*xSetInput)(Th8_Interp *interp, void *pCtx,
		       void *pChannel);
     ...
     *	to default (stdout).
     */
    int   (*xGetOutput)(Th8_Interp *interp, void *pCtx,
			void **pChannel);
    int   (*xSetOutput)(Th8_Interp *interp, void *pCtx,
			void *pChannel);
     ...
     */
    int   (*xGetErrorOutput)(Th8_Interp *interp, void *pCtx,
			     void **pChannel);
    int   (*xSetErrorOutput)(Th8_Interp *interp, void *pCtx,
			     void *pChannel);
     ...
     */
    int   (*xChannelControl)(Th8_Interp *interp, void *pCtx,
		void *pChannel, int op,
		th8_int64_t nArg1, int nArg2,
		th8_int64_t *pnResult, void *pBuf);
     ...
     */
    int   (*xGetTemporaryData)(Th8_Interp *interp, void *pCtx,
		size_t nSize,
		char **pzOut, size_t *pnOut,
		void **ppChannel);
     ...
     */
    int   (*xDeleteTemporaryData)(Th8_Interp *interp, void *pCtx,
		const char *zPath, size_t nPath);
     ...
     */
    int   (*xSetTemporaryData)(Th8_Interp *interp, void *pCtx,
		const char *zName, size_t nName,
		th8_uint64_t nOffset, th8_uint64_t nLength);
     ...
     */
    int   (*xCloseTemporaryData)(Th8_Interp *interp, void *pCtx,
		const char *zName, size_t nName,
		void *pChannel);
     ...
     */
    char *(*xNormalizePath)(Th8_Interp *interp, void *pCtx,
			const char *zPath, size_t nPath);
     ...
     */
    int (*xSetCwd)(Th8_Interp *interp, void *pCtx,
		   const char *zPath, size_t nPath);
     ...
     */
    int   (*xGetRealPath)(Th8_Interp *interp, void *pCtx,
			  const char *zPath, size_t nPath,
			  char *zBuf, size_t nBuf);
     ...
     */
    int   (*xGetRootPath)(Th8_Interp *interp, void *pCtx,
			  const char *zPath, size_t nPath,
			  char *zBuf, size_t nBuf);
     ...
     */
    int   (*xSameFile)(Th8_Interp *interp, void *pCtx,
		       const char *zName1, size_t nName1,
		       const char *zName2, size_t nName2);
     ...
     */
    int   (*xGetData)(Th8_Interp *interp, void *pCtx,
		       const char *zName, size_t nName,
		       char **pzOut, size_t *pnOut);
     ...
     */
    int   (*xDataExists)(Th8_Interp *interp, void *pCtx,
		       const char *zName, size_t nName,
		       int *pAttrs);
     ...
     *	set this to NULL.
     */
    int   (*xLoad)(Th8_Interp *interp, void *pCtx,
		    const char *zName, size_t nName,
		    const char *zProc, size_t nProc);
     ...
     */
    int   (*xUnload)(Th8_Interp *interp, void *pCtx,
		     const char *zName, size_t nName,
		     const char *zProc, size_t nProc,
		     int bClose);
     ...
     */
    int   (*xTimeMs)(Th8_Interp *interp, void *pCtx,
		     th8_int64_t *pMs);
     ...
     */
    int   (*xTimeUs)(Th8_Interp *interp, void *pCtx,
		     th8_int64_t *pUs);
     ...
     */
    int   (*xGetUserName)(Th8_Interp *interp, void *pCtx,
			  char *zBuf, size_t nBuf);
     ...
     */
    int   (*xGetHostName)(Th8_Interp *interp, void *pCtx,
			  char *zBuf, size_t nBuf);
     ...
     */
    char *(*xGetEnv)(Th8_Interp *interp, void *pCtx,
		     const char *zName);
     ...
     */
    int (*xKeyValue)(Th8_Interp *interp, void *pCtx, int op,
		     const char *zName, size_t nName,
		     const char *zValue, size_t nValue);
     ...
     */
    int   (*xGetStackBounds)(Th8_Interp *interp, void *pCtx,
			     void **ppBase, size_t *pnSize);
     ...
     */
    void  (*xSetLastError)(Th8_Interp *interp, void *pCtx,
			   int nErr);
     ...
     *	is disabled.
     */
    void (*xEmitTrace)(Th8_Interp *interp, void *pCtx,
		       const char *zMsg);
     ...
     *	error.  This callback SHALL NOT RETURN.  It must abort the
     *	process (or longjmp, or loop forever).  If NULL, the interpreter
     *	has no panic handler and unrecoverable errors lead to undefined
     *	behavior.
     */
    void  (*xPanic)(Th8_Interp *interp, void *pCtx,
		    const char *zMsg, size_t nMsg);
     ...
     */
    int   (*xMathFunc)(Th8_Interp *interp, void *pCtx,
		       int op, double *pResult,
		       double a, double b);
     ...
     */
    int   (*xRandomBytes)(Th8_Interp *interp, void *pCtx,
			  void *pBuf, size_t nByte);
...
typedef int (*Th8_PolicyProc)(Th8_Interp *interp,
    int phase,
    const char *zName, size_t nName,
    const char *zData, size_t nData,
    int flags, int rc, void *pCtx);

typedef int (*Th8_PreLoadProc)(Th8_Interp *interp,
    const char *zName, size_t nName, void *pCtx);

typedef int (*Th8_CommandProc)(Th8_Interp *interp,
    void *pCtx, int argc, const char **argv, size_t *argl);

typedef int (*Th8_CallbackProc)(Th8_Interp *interp,
    void *pData[4], int rc);
...
#define TH8_CHANCTL_READ   (5)  /* nArg1 = max length; pBuf = buffer; *pnResult = bytes read */
#define TH8_CHANCTL_OPEN   (6)  /* nArg1 = path length; nArg2 = mode (0=rd,1=wr); pBuf = path; *pnResult = handle */
...
TH8_API int Th8_MergePlatform(Th8_Platform *pDst,
 ...
 */
TH8_API int Th8_MergePlatformInterp(Th8_Interp *interp,
    const Th8_Platform *pSrc);
 ...
 *	exists.
 */
TH8_API int Th8_IntCmpXchg(Th8_Interp *interp, volatile int *pTarget,
    int iExchange, int iComparand);
 ...
 */
TH8_API int Th8_CancelEval(Th8_Interp *interp, const char *zMsg,
    size_t nMsg, int flags);
 ...
 */
TH8_API int Th8_SetDebugCallback(Th8_Interp *interp,
 ...
 */
TH8_API int Th8_SetBreakpoint(Th8_Interp *interp,
 ...
 */
TH8_API int Th8_ClearBreakpoint(Th8_Interp *interp,
    int breakpointId);
 ...
 */
TH8_API int Th8_GetFrameInfo(Th8_Interp *interp,
    int frameIndex,
 ...
 */
TH8_API int Th8_EvalAtFrame(Th8_Interp *interp,
    int frameIndex,
    const char *zScript, size_t nScript);
 ...
 */
TH8_API int Th8_CoroCreate(Th8_Interp *interp,
    const char *zName, size_t nName,
 ...
 */
TH8_API int Th8_CoroYield(Th8_Interp *interp,
    const char *zValue, size_t nValue);
 ...
 */
TH8_API int Th8_Eval(Th8_Interp *interp, int iFrame,
    const char *zProg, size_t nProg,
    const char *zName, size_t nName);
 ...
 */
TH8_API int Th8_EvalTrusted(Th8_Interp *interp, int iFrame,
    const char *zProg, size_t nProg,
    const char *zName, size_t nName);
 ...
 *	from.
 */
TH8_API int Th8_EvalDownlevel(Th8_Interp *interp,
    const char *zProg, size_t nProg,
    const char *zName, size_t nName);
 ...
 */
TH8_API int Th8_Expr(Th8_Interp *interp, const char *zExpr, size_t nExpr,
    const char *zName, size_t nName);
 ...
 */
TH8_API int Th8_EvalFile(Th8_Interp *interp, const char *zName,
    size_t nName);
 ...
 *	and must be NULL.
 */
TH8_API int Th8_EvalFileAsData(Th8_Interp *interp,
    const char *zName, size_t nName,
    const unsigned char **pzData, size_t *pnData,
    void *pCtx);
 ...
 */
TH8_API int Th8_NREval(Th8_Interp *interp,
    const char *zProg, size_t nProg,
    const char *zName, size_t nName);
 ...
 */
TH8_API int Th8_NRAddCallback(Th8_Interp *interp,
 ...
 */
TH8_API int Th8_NREvalInFrame(Th8_Interp *interp,
    int iFrame, const char *zProg, size_t nProg,
    const char *zName, size_t nName);
 ...
 */
TH8_API int Th8_ExistsArrayVar(Th8_Interp *interp,
    const char *zVar, size_t nVar);
 ...
 *	memory).
 */
TH8_API int Th8_SetVar(Th8_Interp *interp, const char *zVar, size_t nVar,
    const char *zVal, size_t nVal);
 ...
 *	Returns TH8_OK on success, TH8_ERROR on failure.
 */
TH8_API int Th8_LinkVar(Th8_Interp *interp, const char *zLocal,
    size_t nLocal, int iFrame, const char *zRemote, size_t nRemote);
 ...
 */
TH8_API int Th8_DeleteCommand(Th8_Interp *interp,
    th8_uint64_t token);
 ...
 */
TH8_API int Th8_GetCommandInfo(Th8_Interp *interp, const char *zName,
    size_t nName, Th8_CommandProc *pxProc, void **ppContext);
 ...
 */
TH8_API void Th8_SetCommandCopy(Th8_Interp *interp, const char *zName,
 ...
 *	exist.
 */
TH8_API int Th8_RenameCommand(Th8_Interp *interp, const char *zOld,
    size_t nOld, const char *zNew, size_t nNew);
 ...
 */
TH8_API int Th8_RegisterExpansion(Th8_Interp *interp,
    const char *zTag, size_t nTag,
    Th8_ExpansionProc xProc, void *pCtx);
 ...
 */
TH8_API int Th8_UnregisterExpansion(Th8_Interp *interp,
    const char *zTag, size_t nTag);
 ...
 *	TH8_ERROR if not found.
 */
TH8_API int Th8_FindExpansion(Th8_Interp *interp,
    const char *zTag, size_t nTag,
    Th8_ExpansionProc *pxProc, void **ppCtx);
 ...
 */
TH8_API int Th8_CreateMathFunc(Th8_Interp *interp,
    const char *zName, size_t nName,
    int nArg, Th8_MathFuncProc xProc, void *pCtx);

/*
 * Th8_DeleteMathFunc --
 *	Remove a math function from the interpreter.
 */
TH8_API int Th8_DeleteMathFunc(Th8_Interp *interp,
    const char *zName, size_t nName);
 ...
 */
TH8_API int Th8_FindMathFunc(Th8_Interp *interp,
    const char *zName, size_t nName,
    int *pnArg, Th8_MathFuncProc *pxProc, void **ppCtx);
 ...
 */
TH8_API void Th8_ListAppendMathFunctions(Th8_Interp *interp,
    char **pzList, size_t *pnList,
    const char *zPat, size_t nPat);
 ...
 */
TH8_API int Th8_GlobMatch(Th8_Interp *interp,
    const char *zPat, size_t nPat,
    const char *zStr, size_t nStr);
...
#define TH8_SUBST_ALL		(TH8_SUBST_BACKSLASHES \
				| TH8_SUBST_COMMANDS \
				| TH8_SUBST_VARIABLES)

TH8_API int Th8_Subst(Th8_Interp *interp, const char *z, size_t n,
    int flags);
...
TH8_API int Th8_RsaKeyLoad(Th8_Interp *interp,
    const unsigned char *zData, size_t nData,
    Th8_RsaKey **ppKey);

TH8_API void Th8_RsaKeyFree(Th8_Interp *interp,
    Th8_RsaKey *pKey);
...
TH8_API const unsigned char *Th8_RsaKeyModulus(
    const Th8_RsaKey *pKey, size_t *pn);
TH8_API const unsigned char *Th8_RsaKeyPrivExp(
    const Th8_RsaKey *pKey, size_t *pn);
TH8_API const unsigned char *Th8_RsaKeyPrime1(
    const Th8_RsaKey *pKey, size_t *pn);
TH8_API const unsigned char *Th8_RsaKeyPrime2(
    const Th8_RsaKey *pKey, size_t *pn);
 ...
 */
TH8_API int Th8_RsaKeyToken(Th8_Interp *interp,
    const Th8_RsaKey *pKey, unsigned char zOut[8]);
 ...
 */
TH8_API int Th8_RsaKeyTokenHex(Th8_Interp *interp,
    const Th8_RsaKey *pKey, char zOut[17]);
 ...
 *	Th8_Free.
 */
TH8_API int Th8_HarpySigLoad(Th8_Interp *interp,
    const char *zData, size_t nData,
    unsigned char **ppSig, size_t *pnSig,
    char **ppToken);
 ...
 */
TH8_API int Th8_RsaVerify(Th8_Interp *interp,
    const Th8_RsaKey *pKey,
    const unsigned char *zData, size_t nData,
    const unsigned char *zSig, size_t nSig);
 ...
 */
TH8_API int Th8_RsaSign(Th8_Interp *interp,
    const Th8_RsaKey *pKey,
    const unsigned char *zData, size_t nData,
    unsigned char **ppSig, size_t *pnSig);
 ...
 */
TH8_API int Th8_Sha512Hex(Th8_Interp *interp,
    const unsigned char *zData, size_t nData,
    char zOut[129]);
 ...
 */
TH8_API int Th8_RsaExtractHash(Th8_Interp *interp,
    const Th8_RsaKey *pKey,
    const unsigned char *zSig, size_t nSig,
    char zOut[129]);
 ...
 */
TH8_API int Th8_InstallSignedPolicy(Th8_Interp *interp,
    void **ppCtx);
 ...
 */
TH8_API void Th8_RemoveSignedPolicy(Th8_Interp *interp,
    void *pCtx);
 ...
 */
TH8_API int Th8_PolicyPreloadKey(Th8_Interp *interp,
    void *pCtx, Th8_RsaKey *pKey);
 ...
 */
TH8_API int Th8_PolicyGetKeyTokens(Th8_Interp *interp,
    void *pCtx);
 ...
 */
TH8_API const Th8_RsaKey *Th8_PolicyFindKey(Th8_Interp *interp,
    void *pCtx, const char *zToken, size_t nToken);
 ...
 */
TH8_API int Th8_EnableSignedPolicy(Th8_Interp *interp,
    void **ppCtx, int bEnable);
 ...
 */
TH8_API int Th8_EvalFileAndRsaKeyLoad(Th8_Interp *interp,
    const char *zName, size_t nName,
    void *pCtx, int bPreload);
 ...
 *	Returns TH8_OK on success.
 */
TH8_API int Th8_GetPublicKeyZeroToken(Th8_Interp *interp,
    char zOut[17]);
 ...
 *	Returns TH8_OK on success.
 */
TH8_API int Th8_GetPublicKeyRootToken(Th8_Interp *interp,
    char zOut[17]);
 ...
 *	Only available when TH8_ENABLE_TEST_KEY is defined.
 */
TH8_API int Th8_GetPublicKeyTestToken(Th8_Interp *interp,
    char zOut[17]);
#endif
 ...
 */
TH8_API int Th8_Pledge(Th8_Interp *interp, const char *zPromises,
 ...
 *	On non-OpenBSD platforms, always returns TH8_OK.
 */
TH8_API int Th8_Unveil(Th8_Interp *interp, const char *zPath,
 ...
 */
TH8_API void Th8_SetResultStatic(Th8_Interp *interp,
 ...
 */
TH8_API int Th8_ErrorMessage(Th8_Interp *interp, const char *zPre,
    const char *z, size_t n);
...
TH8_API void Th8_SaveSignedOnly(Th8_Interp *interp,
    void *pSaved);
TH8_API void Th8_RestoreSignedOnly(Th8_Interp *interp,
    const void *pSaved);
 ...
 */
TH8_API int Th8_DeclareSystemVar(Th8_Interp *interp,
    const char *zName, size_t nName);
 ...
 */
TH8_API int Th8_IsSystemVar(Th8_Interp *interp,
    const char *zName, size_t nName);
 ...
 */
TH8_API int Th8_Load(Th8_Interp *interp, const char *zName, size_t nName,
    const char *zProc, size_t nProc);
#endif
 ...
 */
TH8_API int Th8_Unload(Th8_Interp *interp, const char *zName, size_t nName,
    const char *zProc, size_t nProc, int bClose);
#endif
 ...
 */
TH8_API void Th8_SetPolicyCallback(Th8_Interp *interp,
    Th8_PolicyProc xProc, void *pCtx);
 ...
 */
TH8_API void Th8_SetPreLoadCallback(Th8_Interp *interp,
    Th8_PreLoadProc xProc, void *pCtx);
#endif
 ...
 */
TH8_API void Th8_GetPolicyCallback(Th8_Interp *interp,
    Th8_PolicyProc *pxProc, void **ppCtx);
 ...
 */
TH8_API int Th8_GetFrameObjv(Th8_Interp *interp,
    int iLevel, int *pArgc, const char ***pArgv,
    size_t **pArgl);
 ...
 *	exceeded).
 */
TH8_API int Th8_StringAppend(Th8_Interp *interp, char **pzStr,
    size_t *pnStr, const char *zApp, size_t nApp);
 ...
 */
TH8_API int Th8_ListAppend(Th8_Interp *interp, char **pzList,
    size_t *pnList, const char *zElem, size_t nElem);
 ...
 */
TH8_API int Th8_SplitList(Th8_Interp *interp, const char *zList,
    size_t nList, char ***pazElem, size_t **panElem, int *pnCount);
 ...
 */
TH8_API int Th8_ToInt(Th8_Interp *interp, const char *z, size_t n,
    int *piVal);
 ...
 */
TH8_API int Th8_ToBoolean(Th8_Interp *interp, const char *z, size_t n,
    int *pbVal);
 ...
 */
TH8_API int Th8_ToWideInt(Th8_Interp *interp, const char *z, size_t n,
    th8_int64_t *pwVal);
 ...
 */
TH8_API int Th8_ToDouble(Th8_Interp *interp, const char *z, size_t n,
    double *prVal);
 ...
 */
TH8_API int Th8_ListAppendCommands(Th8_Interp *interp,
    char **pz, size_t *pn);
 ...
 */
TH8_API int Th8_ListAppendCommandsMatching(Th8_Interp *interp,
    char **pz, size_t *pn,
    Th8_CommandProc xMatch1, Th8_CommandProc xMatch2);
 ...
 *	*pz / *pn.  Returns TH8_OK.
 */
TH8_API int Th8_ListAppendVariables(Th8_Interp *interp,
    char **pz, size_t *pn);
 ...
 */
TH8_API int Th8_ListAppendNsVariables(Th8_Interp *interp,
    const char *zNs, size_t nNs, char **pz, size_t *pn);

/*
 * Th8_ListAppendGlobalVariables --
 *	Like Th8_ListAppendVariables but iterates the global frame.
 */
TH8_API int Th8_ListAppendGlobalVariables(Th8_Interp *interp,
    char **pz, size_t *pn);
 ...
 *	Returns TH8_OK.
 */
TH8_API int Th8_ListAppendVarLinks(Th8_Interp *interp,
    char **pz, size_t *pn);
 ...
 */
TH8_API int Th8_ListAppendArray(Th8_Interp *interp,
    const char *zArr, size_t nArr, char **pz, size_t *pn);
 ...
 */
TH8_API int Th8_CallSubCommand(Th8_Interp *interp, void *ctx,
 ...
 *	(after reporting).
 */
TH8_API int Th8_ReportTaint(Th8_Interp *interp, const char *zTitle,
    const char *zStr, size_t nStr);
 ...
 */
TH8_API int Th8_Input(Th8_Interp *interp, char **pzOut, size_t *pnOut,
    int flags);
 ...
 *	Returns TH8_OK or TH8_ERROR.
 */
TH8_API int Th8_Output(Th8_Interp *interp, const char *z, size_t n,
    int flags);
 ...
 *	Returns TH8_OK or TH8_ERROR.
 */
TH8_API int Th8_GetData(Th8_Interp *interp, const char *zName,
    size_t nName, char **pzOut, size_t *pnOut, int flags);
 ...
 */
TH8_API int Th8_DataExists(Th8_Interp *interp, const char *zName,
    size_t nName, int *pAttrs);
 ...
 */
TH8_API char *Th8_NormalizePath(Th8_Interp *interp, const char *zPath,
    size_t nPath);
 ...
 */
TH8_API int Th8_SetCwd(Th8_Interp *interp, const char *zPath,
    size_t nPath);
 ...
 */
TH8_API int Th8_GetRealPath(Th8_Interp *interp,
    const char *zPath, size_t nPath, char *zBuf, size_t nBuf);
 ...
 */
TH8_API int Th8_GetRootPath(Th8_Interp *interp,
    const char *zPath, size_t nPath, char *zBuf, size_t nBuf);
 ...
 */
TH8_API int Th8_SameFile(Th8_Interp *interp,
    const char *zName1, size_t nName1,
    const char *zName2, size_t nName2);
 ...
 */
TH8_API void Th8_SetPackageUnknown(Th8_Interp *interp,
    const char *zCmd, size_t nCmd);
 ...
 */
TH8_API int Th8_AutoPathSearch(Th8_Interp *interp, char *zAuto,
    size_t nAuto);
 ...
 *	and bCreate is zero.
 */
TH8_API int Th8_FindNamespace(Th8_Interp *interp,
    const char *zName, size_t nName, int bCreate);
 ...
 */
TH8_API int Th8_DeleteNamespace(Th8_Interp *interp,
    const char *zName, size_t nName);
 ...
 *	a TH8_* return code.
 */
TH8_API int Th8_NsEval(Th8_Interp *interp, const char *zNs,
    size_t nNs, const char *zScript, size_t nScript);
 ...
 */
TH8_API int Th8_ListAppendNsChildren(Th8_Interp *interp,
    const char *zNs, size_t nNs, char **pz, size_t *pn);
 ...
 */
TH8_API int Th8_NsExport(Th8_Interp *interp, const char *zNs,
    size_t nNs, const char *zPattern, size_t nPattern);
 ...
 */
TH8_API int Th8_NsImport(Th8_Interp *interp, const char *zPattern,
    size_t nPattern, int bForce);
 ...
 */
TH8_API void Th8_PushSourceName(Th8_Interp *interp,
    const char *zName, size_t nName);
TH8_API void Th8_PopSourceName(Th8_Interp *interp);
TH8_API const char *Th8_GetSourceName(Th8_Interp *interp,
    size_t *pnName);
 ...
 */
TH8_API int Th8_KeyValue(Th8_Interp *interp, int op,
    const char *zName, size_t nName,
    const char *zValue, size_t nValue);
 ...
 */
TH8_API int Th8_SetPlatformContext(Th8_Interp *interp,
 ...
 */
TH8_API int Th8_GetPlatformContext(Th8_Interp *interp,
    void *xCallback, void **ppCtx);
 ...
 */
TH8_API int Th8_RandomBytes(Th8_Interp *interp,
    void *pBuf, size_t nByte);
 ...
 *	platform table.
 */
TH8_API int Th8_Memcmp(Th8_Interp *interp, const void *a,
 ...
 */
TH8_API void *Th8_Memcpy(Th8_Interp *interp, void *dst,
 ...
 *	Returns dst.
 */
TH8_API void *Th8_Memset(Th8_Interp *interp, void *dst,
    int c, size_t n);
 ...
 */
TH8_API int Th8_FaultInstall(Th8_Interp *interp,
    Th8_FaultConfig *pConfig, Th8_FaultCtx *pCtx);
 ...
 */
TH8_API int Th8_FaultUninstall(Th8_Interp *interp,
    Th8_FaultCtx *pCtx);
 ...
 */
TH8_API int Th8_SaveSystemVar(Th8_Interp *interp,
    const char *zArr, size_t nArr, void **ppSaved);
TH8_API int Th8_RestoreSystemVar(Th8_Interp *interp,
    const char *zArr, size_t nArr, void *pSaved);
...
TH8_API int Th8_AttrFlagsParse(Th8_Interp *interp,
    const char *zText, size_t nText,
    int bComplex, int bSpace, Th8_AfMap *pMap);
TH8_API int Th8_AttrFlagsFormat(Th8_Interp *interp,
    const Th8_AfMap *pMap, int bLegacy, int bCompact,
    int bSpace, int bSort, char **pzOut, size_t *pnOut);
TH8_API int Th8_AttrFlagsHave(const Th8_AfMap *pMap,
    th8_int64_t key, const char *zHave, size_t nHave,
    int bAll, int bStrict);
TH8_API int Th8_AttrFlagsChange(Th8_Interp *interp,
    Th8_AfMap *pMap, const char *zChange, size_t nChange,
    th8_int64_t key);
 ...
 */
TH8_API void *Th8_AttemptRealloc(Th8_Interp *interp, void *p,
    size_t nByte);
 ...
 */
TH8_API int Th8_ListAppendLoaded(Th8_Interp *interp,
    char **pz, size_t *pn);
#endif
 ...
 */
TH8_API void Th8_GetCacheStats(Th8_Interp *interp,
    th8_uint64_t *pnHit, th8_uint64_t *pnMiss,
 ...
 */
TH8_API Th8_Value *Th8_FindInCache(Th8_Interp *interp,
    int cacheType, const char *z, size_t n);
